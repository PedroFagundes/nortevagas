...
urlpatterns = [
    ...
    url(r'^ocupar/(?P<job_pk>\d+)/$', 'jobs.views.toggle_job_filled', name='toggle_job_filled'),
    url(r'^remover/(?P<job_pk>\d+)/$', 'jobs.views.toggle_job_active', name='toggle_job_active'),
    url(r'^favoritar/(?P<job_pk>\d+)/$', 'jobs.views.bookmark_job', name='bookmark_job'),
    url(r'^candidatar/(?P<job_pk>\d+)/$', 'jobs.views.apply_to_job', name='apply_to_job'),
